...
TRAIN_DIR = 'C:/Users/Admin/PycharmProjects/car_training/Sign_Data'
OWN_IMAGE_PATH = 'C:/Users'

train_img_count = 0
train_images = []
CATEGORIES = ["No_Signs", "Signs"]
...
model = keras.Sequential([
    ...
    keras.layers.Dense(2, activation="softmax")  # normal softmax
])

model.compile(optimizer='adam', loss=keras.losses.sparse_categorical_crossentropy, metrics=['accuracy'])

history = model.fit(X, y, batch_size=80, epochs=EPOCHS, validation_split=0.25)
